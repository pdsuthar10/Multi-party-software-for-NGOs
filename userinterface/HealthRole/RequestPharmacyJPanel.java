...
public class RequestPharmacyJPanel extends javax.swing.JPanel {
    ...
    public RequestPharmacyJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, Network network) {
        ...
        //userAccount.setMedicineList(new ArrayList<Medicine>());
//        userAccount.getMedicineList().clear();
...
//         List<Medicine> medList = new ArrayList<Medicine>(userAccount.getMedicineList());
        ...
        request.setMedicineList(medicineList);
...
//            MedicineJPanel panel = new MedicineJPanel(userProcessContainer, medicine, 0);
//            userProcessContainer.add("MedicineJPanel", panel);
//            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
...
//        userAccount.getMedicineList().add(medicine);
